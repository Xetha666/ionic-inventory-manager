  ...
  return (
    <IonModal isOpen={isOpen} onDidDismiss={onClose} backdropDismiss={false} className="create-user-modal">
      <div className="flex flex-col h-full bg-surface-container-lowest overflow-hidden">
        {/* Header */}
        <div className="flex items-center px-6 py-5 border-b border-outline-variant/10 shrink-0">
        ...
        <form className="flex-1 flex flex-col min-h-0" onSubmit={handleSubmit}>
          ...
          <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-md">
            {message && (
              <div
                className={`p-4 rounded-2xl text-sm font-medium border shrink-0 ${
          ...
          <div className="flex gap-sm p-6 border-t border-outline-variant/10 bg-surface-container-lowest shrink-0">
